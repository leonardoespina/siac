      ...
      <div class="col-12 col-sm-8 col-md-5 col-lg-3">
        ...
        <q-card class="q-pa-xl shadow-2" style="border-radius: 12px;">
          ...
          <q-card-section class="text-center q-pb-none">
            ...
            <div class="text-body2 text-weight-bold text-grey-8">
              Sistema de Registro y Control de Combustible
            </div>
          </q-card-section>
          ...
          <q-card-section class="text-center q-pt-none q-pb-lg">
            <div class="text-h5 text-weight-bold text-blue-grey-9">Bienvenido</div>
            <div class="text-body2 text-grey-6">Inicia sesión para continuar</div>
          </q-card-section>
