    ...
    <div v-else>
      <q-card bordered flat>
        ...
        >
          ...
          <!-- MODO MÓVIL (GRID): Tarjeta Compacta Desplegable -->
            ...
            <div class="q-pa-xs col-12 col-sm-6 col-md-4">
              <q-card bordered flat class="bg-grey-1">
                ...
                <q-card-actions align="center" class="bg-white">
                  <q-btn flat color="primary" class="full-width" :label="props.expand ? 'Ocultar Transacciones' : 'Ver Transacciones'" @click="props.expand = !props.expand" :icon="props.expand ? 'expand_less' : 'expand_more'" />
                </q-card-actions>
