          ...
          <q-card-section v-if="diner" class="q-pt-md">
            <div class="row items-center">
              <div class="col-auto q-pr-md">
                <q-avatar size="72px" :color="diner.fingerprint ? 'positive' : 'grey-5'" text-color="white">
                  <q-icon name="person" size="40px" />
                  <q-badge floating color="white" :text-color="diner.fingerprint ? 'positive' : 'grey-8'" rounded>
                    <q-icon :name="diner.fingerprint ? 'check_circle' : 'warning'" size="xs" />
                  </q-badge>
                </q-avatar>
              </div>
              <div class="col">
                ...
                <div class="q-mt-xs">
                  <q-chip
                    :color="diner.fingerprint ? 'positive' : 'negative'"
                    text-color="white"
                    dense
                    icon="fingerprint"
                  >
                    {{ diner.fingerprint ? 'Huella Registrada' : 'Sin Huella' }}
                  </q-chip>
                </div>
              </div>
            </div>
            ...
            <div class="row q-gutter-sm q-mt-lg justify-end">
              ...
              <q-btn
                color="primary"
                :label="diner.fingerprint ? 'Actualizar Huella' : 'Registrar Biometría'"
                icon="touch_app"
